    ...
    <div className="about-container">
      ...
      <div className="team-grid">
        ...
        <div className="team-card">
          <img src="https://via.placeholder.com/500x300" alt="John Doe" className="team-image" />
        ...
        {/* Segundo integrante */}
        <div className="team-card">
          <img src="https://via.placeholder.com/500x300" alt="Jane Smith" className="team-image" />
          <div className="team-content">
